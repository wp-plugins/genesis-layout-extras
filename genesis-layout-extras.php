 ...
 * homepage, singular, archive, attachment, search, 404 and even bbPress 2.0 pages via Genesis theme settings.
 *
 ...
 * Description: This plugin for Genesis Theme Framework allows modifying of default layouts for homepage, singular, archive, attachment, search, 404 and even bbPress 2.0 pages via Genesis theme settings.
 * Version: 1.1
 ...
 * @since 1.0
 */
load_plugin_textdomain( 'genesis-layout-extras', false, 'genesis-layout-extras/languages' );
...
if ( isset( $_GET['page'] ) && $_GET['page'] == 'gle-layout-extras' ) {
...
function ddw_genesis_layout_extras_register_settings() {
	...
	if ( genesis_get_option( 'reset', GLE_SETTINGS_FIELD ) ) {
...
function ddw_genesis_layout_extras_theme_settings_boxes() {
	...
	function ddw_genesis_layout_extras_box() {
		...
		// bbPress 2.0 Forum section
		echo '<h4>' . __( 'Plugin: bbPress 2.0 Forum Section', GLE_DOMAIN ) . '</h4>';

			ddw_genesis_layout_extras_option( __( 'bbPress 2.0 Forum Layout (all areas): ', GLE_DOMAIN ), 'ddw_genesis_layout_bbpress' );

			echo '<p><span class="description">' . sprintf( __( 'For this setting to take any effect the %1$splugin <em>bbPress 2.0+</em>%2$s needs to be installed first.', GLE_DOMAIN ), '<a href="http://wordpress.org/extend/plugins/bbpress/" target="_new" title="Plugin: bbPress 2.0+ Forum ...">', '</a>' ) . '</span></p>';
...
/**
 * Manage Genesis layouts for bbPress 2.0 Forum section (plugin)
 *
