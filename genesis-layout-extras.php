...
define( 'GLE_SETTINGS_FIELD', 'gle-settings-test' );
...
function ddw_genesis_layout_extras_settings_link( $links ) {
	...
	$ddw_gle_settings_link = sprintf( '<a href="%s">%s</a>' , admin_url( 'admin.php?page=gle-layout-extras' ) , __( 'Settings', GLE_DOMAIN ) );
...
function ddw_genesis_layout_extras_contextual_help($contextual_help, $screen_id, $screen) {
	...
	echo '<h4>' . __( 'Author - License - Donations - Support', GLE_DOMAIN ) . '</h4>';
	...
	echo '<p>&bull; ' . sprintf( __( '<strong>Donations:</strong> Please %1$sdonate to support the further maintenance and development%2$s of the plugin. <em>Thank you in advance!</em>', GLE_DOMAIN ), '<a href="http://genesisthemes.de/en/donate/" target="_new">', '</a>' ) . '</p>';
...
function ddw_genesis_layout_extras_theme_settings_boxes() {
	...
	function ddw_genesis_layout_extras_box() {
		...
		echo '<h4>' . __( 'Special Custom Post Sections', GLE_DOMAIN ) . '</h4>';

			ddw_genesis_layout_extras_option( __( 'AgentPress Listing Post Type Layout: ', GLE_DOMAIN ), 'ddw_genesis_layout_cpt_apl_listing' );

			echo '<p><span class="description">' . sprintf( __( 'For this setting to take any effect the %1$splugin <em>AgentPress Listings</em>%2$s needs to be installed first.', GLE_DOMAIN ), '<a href="http://deckerweb.de/go/agentpress-listings/" target="_new" title="Plugin: AgentPress Listings ...">', '</a>' ) . '</span></p>';
		...
		echo '<h4>' . __( 'Plugin: bbPress 2.0 Forum Section', GLE_DOMAIN ) . '</h4>';
			...
			ddw_genesis_layout_extras_option( __( 'bbPress 2.0 Forum Layout: ', GLE_DOMAIN ), 'ddw_genesis_layout_bbpress' );
...
function ddw_genesis_layout_extras_filter( $opt ) {
	...
	if ( is_home() && genesis_get_option( 'ddw_genesis_layout_home', GLE_SETTINGS_FIELD ) )
